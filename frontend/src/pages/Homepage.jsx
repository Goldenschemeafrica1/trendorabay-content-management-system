                  ...
                  {mainCoverStory ? (
                    <div style={{ textAlign: 'center', width: '100%' }}>
                      ...
                      {mainCoverStory.featured_image_url && (
                        <img 
                          src={mainCoverStory.featured_image_url.startsWith('http') ? mainCoverStory.featured_image_url : `https://trendorabay-content-management-system.onrender.com${mainCoverStory.featured_image_url}`}
                          alt="Cover"
                          style={{ 
                            width: '100%', 
                            height: '250px', 
                ...
                {allMagazines.slice(0, 6).map((magazine) => (
                  <div key={magazine.id} style={{
                    ...
                    {magazine.cover_image_url && (
                      <img 
                        src={magazine.cover_image_url.startsWith('http') ? magazine.cover_image_url : `https://trendorabay-content-management-system.onrender.com${magazine.cover_image_url}`}
                        alt={magazine.title}
                        style={{ 
                          width: '50px', 
                          height: '60px', 
