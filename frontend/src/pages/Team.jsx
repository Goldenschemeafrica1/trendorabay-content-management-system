          ...
          onMouseLeave={(e) => {
            ...
            <div style={{ 
              ...
              background: member.avatar_url 
                ? `url(https://trendorabay-content-management-system.onrender.com${member.avatar_url}) center/cover no-repeat`
                  ...
                  {formData.avatar_url && (
                    <div style={{ marginTop: '12px' }}>
                      ...
                      <div style={{
                        ...
                        <img
                          src={`https://trendorabay-content-management-system.onrender.com${formData.avatar_url}`}
                          alt="Avatar Preview"
                          style={{
                            maxWidth: '100%',
                            maxHeight: '100%',
