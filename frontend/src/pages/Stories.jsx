...
export default function Stories() {
  ...
  const handleEditStory = (story) => {
    ...
    setCoverImagePreview(story.cover_image_url ? `https://trendorabay-content-management-system.onrender.com${story.cover_image_url}` : null)
            ...
            <div style={{ padding: '20px', overflowY: 'auto', maxHeight: 'calc(80vh - 120px)' }}>
              {viewingStory.featured_image_url && (
                <div style={{ 
                  ...
                  <img 
                    src={`https://trendorabay-content-management-system.onrender.com${viewingStory.featured_image_url}`} 
                    alt="Featured" 
                    style={{ 
                      width: '100%', 
                      height: '220px', 
