                  ...
                  {formData.image_url && (
                    <div style={{ marginTop: '12px' }}>
                      ...
                      <div style={{
                        ...
                        <img
                          src={formData.image_url.startsWith('http') ? formData.image_url : `https://trendorabay-content-management-system.onrender.com${formData.image_url}`}
                          alt="Desktop Preview"
                          style={{
                            maxWidth: '100%',
                            maxHeight: '100%',
                  ...
                  {formData.mobile_image_url && (
                    <div style={{ marginTop: '12px' }}>
                      ...
                      <div style={{
                        ...
                        <img
                          src={formData.mobile_image_url.startsWith('http') ? formData.mobile_image_url : `https://trendorabay-content-management-system.onrender.com${formData.mobile_image_url}`}
                          alt="Mobile Preview"
                          style={{
                            maxWidth: '100%',
                            maxHeight: '100%',
