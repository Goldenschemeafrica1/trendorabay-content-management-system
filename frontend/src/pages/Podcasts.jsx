...
export default function Podcasts() {
  ...
  const handleEditPodcast = (podcast) => {
    ...
    setCoverArtPreview(podcast.cover_art_url ? (podcast.cover_art_url.startsWith('http') ? podcast.cover_art_url : `https://trendorabay-content-management-system.onrender.com${podcast.cover_art_url}`) : null)
  ...
  const handlePlayAudio = (podcast) => {
    ...
    if (playingAudio === podcast.id) {
      ...
      // Play new audio
      const audio = new Audio(podcast.audio_file_url.startsWith('http') ? podcast.audio_file_url : `https://trendorabay-content-management-system.onrender.com${podcast.audio_file_url}`)
      audio.play()
      setAudioRef(audio)
          ...
          onMouseLeave={(e) => {
            ...
            <div style={{ 
              ...
              background: podcast.cover_art_url 
                ? `url(${podcast.cover_art_url.startsWith('http') ? podcast.cover_art_url : `https://trendorabay-content-management-system.onrender.com${podcast.cover_art_url}`}) center/cover no-repeat` 
