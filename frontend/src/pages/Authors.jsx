...
export default function Authors() {
  ...
  setAvatarPreview(author.avatar_url ? (author.avatar_url.startsWith('http') ? author.avatar_url : `https://trendorabay-content-management-system.onrender.com${author.avatar_url}`) : null)
                ...
                <td style={{ padding: '12px 16px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    <div style={{
                      ...
                      {author.avatar_url ? (
                        <img 
                          src={author.avatar_url.startsWith('http') ? author.avatar_url : `https://trendorabay-content-management-system.onrender.com${author.avatar_url}`}
                          alt={author.name}
                          style={{ 
                            width: '100%', 
                            height: '100%', 
