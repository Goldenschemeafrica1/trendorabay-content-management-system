...
const navigation = [
  ...
  { name: 'Podcast Hosts', href: '/podcast-hosts', icon: UserIcon },
  { name: 'Podcast Guests', href: '/podcast-guests', icon: UserCheck },
  { name: 'Guest Applications', href: '/guest-applications', icon: UserCheck },
  { name: 'Pitch Submissions', href: '/pitch-submissions', icon: Lightbulb },
  { name: 'Authors', href: '/authors', icon: Users },
  { name: 'User Management', href: '/users', icon: Users },
  { name: 'Media Library', href: '/media', icon: ImageIcon },
  { section: 'Store' },
  { name: 'Products', href: '/merchandise', icon: ShoppingBag },
  { name: 'Orders', href: '/orders', icon: Package },
  { section: 'Analytics' },
  { folder: 'Analytics', icon: TrendingUp, items: [
    { name: 'Traffic', href: '/analytics', icon: TrendingUp },
  ...
  { name: 'Community Hub', href: '/community', icon: MessageCircle },
  { section: 'Pages' },
  { name: 'Homepage', href: '/homepage', icon: Home },
  { name: 'PodcastPage', href: '/podcast', icon: File },
  { name: 'Store', href: '/store', icon: ShoppingBag },
  { name: 'Mission', href: '/mission', icon: File },
  { name: 'Team', href: '/team', icon: TeamIcon },
  { name: 'Contact Messages', href: '/contact-messages', icon: Inbox },
  { section: 'Advertisers' },
  { name: 'Partners', href: '/partners', icon: Building2 },
  { name: 'Sponsorships', href: '/sponsorships', icon: Award },
  { name: 'Advertisements', href: '/advertisements', icon: ImageIcon },
  { name: 'Ad Inquiries', href: '/advertisement-inquiries', icon: Mail },
  { section: 'Subscriptions' },
  { name: 'Plans', href: '/plans', icon: CreditCard },
  { name: 'Subscribers', href: '/subscribers', icon: SubscribersIcon },
  { section: 'Settings' },
